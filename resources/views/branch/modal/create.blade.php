<div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="ModalCreateBranch" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    ...
                    <div class="card shadow-lg border-1 border-dark rounded-lg">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="row gx-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="inputDivisi" type="text" aria-describedby="divisiHelp" placeholder="Divisi" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row gx-3">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="inputJabatan" type="text" aria-describedby="jabatanHelp" placeholder="Jabatan" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputFlag">Flag</label>
                                            <input class="form-control" id="inputFlag" type="text" aria-describedby="flagHelp" placeholder="Flag" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="btn btn-primary btn-block btn-sm float-end" href="auth-login-basic.html">Create Account</a>
                            </form>
                        </div>
                    </div>
                </div>
