                ...
                <main>
                    <div class="container-xl px-4">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <!-- Basic login form-->
                                <div class="card shadow-sm border-1 border-dark rounded-lg mt-5" style="background-color:#fff;">
                                    <div class="text-center fw-bold">CENTRAL MANAGEMANT KOPERASI</div>
                                    <div class="card-header justify-content-center text-center" style="background-color:#4FC3F7;">
                                        <h3 class="fw-light fw-bold my-4">CMK</h3>
                                    </div>
                                    <div class="card-body">
                                        <!-- Login form-->
                                        <form>
                                           ...
                                           <!-- Form Group (login box)-->
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <div>
                                                    <a class="btn rounded ms-2 btn-primary btn-sm" href="/log">LOGIN</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
